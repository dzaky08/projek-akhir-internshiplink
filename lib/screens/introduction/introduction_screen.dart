                ...
                Positioned(
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(
                        24, MediaQuery.of(context).size.height * 0.03, 24, 20),
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(5,
                              MediaQuery.of(context).size.height * 0.09, 24, 0),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.fromLTRB(
                                    0,
                                    50,
                                    MediaQuery.of(context).size.height * 0.139,
                                    10),
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10),
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(
                        24, MediaQuery.of(context).size.height * 0.03, 24, 5),
                    width: double.infinity,
                    height: MediaQuery.of(context).size.height * 0.43,
                    decoration: const BoxDecoration(
                        color: EVColor.neutral10,
